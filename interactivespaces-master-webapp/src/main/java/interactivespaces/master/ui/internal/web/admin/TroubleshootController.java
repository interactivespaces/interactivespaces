...
public class TroubleshootController extends BaseSpaceMasterController {
	...
	/**
	 * @param networkInformationClient the networkInformationClient to set
	 */
	public void setNetworkInformationClient(
			NetworkInformationClient networkInformationClient) {
