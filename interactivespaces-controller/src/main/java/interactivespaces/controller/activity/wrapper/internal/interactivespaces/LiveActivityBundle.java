...
public class LiveActivityBundle {
	...
	public LiveActivityBundle(BundleContext bundleContext,
	...
	public Bundle getBundle(File bundleFile) {
		String newBundleSignature = bundleSignature
				.getBundleSignature(bundleFile);
	...
	private void loadNewBundle(File newBundleFile, String newBundleFileSignature) {
		try {
			...
			throw new InteractiveSpacesException(String.format(
					"Cannot load bundle %s", newBundleFile.getAbsolutePath()),
					e);
		}
	}
