...
public class SimpleLiveActivityBundleLoader implements LiveActivityBundleLoader {
	...
	@Override
	public synchronized Class<?> getBundleClass(File bundleFile,
			String bundleName, String bundleVersion, String className) {
		...
		try {
			...
			throw new InteractiveSpacesException(String.format(
					"Could not load class %s from bundle", className));
		}
	}
