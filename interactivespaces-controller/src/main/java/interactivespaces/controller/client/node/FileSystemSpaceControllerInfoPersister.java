 ...
 */
public class FileSystemSpaceControllerInfoPersister implements
		SpaceControllerInfoPersister {

	@Override
	public void persist(SpaceController controllerInfo,
			InteractiveSpacesEnvironment spaceEnvironment) {
		Properties props = new Properties();
		props.put(
				interactivespaces.controller.SpaceController.CONFIGURATION_CONTROLLER_UUID,
				controllerInfo.getUuid());
		props.put(
				interactivespaces.controller.SpaceController.CONFIGURATION_CONTROLLER_NAME,
