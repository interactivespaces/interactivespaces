...
/**
 * Provide communications between a Space Controller and something controlling it.
 *
...
public interface SpaceControllerCommunicator {
  ...
  /**
   * Create a {@link SpaceControllerHeartbeat} appropriate for the communication channel.
   *
   ...
   */
  void publishControllerDataStatus(SpaceControllerDataOperation type, SpaceControllerStatus statusCode, Exception e);
}
