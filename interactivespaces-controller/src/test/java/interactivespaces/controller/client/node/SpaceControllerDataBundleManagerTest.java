...
public class SpaceControllerDataBundleManagerTest {
  ...
  public void setup() {
    SpaceController spaceController = Mockito.mock(SpaceController.class, RETURNS_DEEP_STUBS);
    ...
    doAnswer(new Answer<Void>() {
      ...
      public Void answer(InvocationOnMock invocation) throws Exception {
        ...
        testResults.zipBasePath = (File) invocation.getArguments()[1];
        return null;
      }
    }).when(fileSupport).zip(any(File.class), any(File.class));
    doAnswer(new Answer<Void>() {
      @Override
      public Void answer(InvocationOnMock invocation) throws Exception {
  ...
  public void testCaptureControllerDataBundle() {
    ...
    assertEquals(TEST_DATA_DIRECTORY, testResults.zipBasePath);
