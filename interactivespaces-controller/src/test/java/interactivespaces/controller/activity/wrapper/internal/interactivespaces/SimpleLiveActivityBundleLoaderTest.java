...
public class SimpleLiveActivityBundleLoaderTest {
	...
	public void setup() {
		...
		loader = new SimpleLiveActivityBundleLoader(bundleContext,
				bundleSignature);
	}
	...
	public void testOneLoad() throws Exception {
		...
		Class<?> clazz = loader.getBundleClass(bundleFile, bundleName,
	...
	public void testTwoLoad() throws Exception {
		...
		Class<?> clazz1 = loader.getBundleClass(bundleFile1, bundleName1,
				bundleVersion1, className1);
		Class<?> clazz2 = loader.getBundleClass(bundleFile2, bundleName2,
				bundleVersion2, className2);
	...
	public void testTwoLoadSameFile() throws Exception {
		...
		Class<?> clazz1 = loader.getBundleClass(bundleFile, bundleName,
				bundleVersion, className);
		Class<?> clazz2 = loader.getBundleClass(bundleFile, bundleName,
				bundleVersion, className);
	...
	public void testTwoLoadSignatureDifferent() throws Exception {
		...
		when(bundleContext.installBundle(bundleFileUri)).thenReturn(bundle1)
				.thenReturn(bundle2);
	...
	/**
	 * Load a name/version pair with different files, but the
	...
	public void testTwoLoadSignatureSame() throws Exception {
		...
		Class<?> clazz1 = loader.getBundleClass(bundleFile1, bundleName,
				bundleVersion, className);
		Class<?> clazz2 = loader.getBundleClass(bundleFile2, bundleName,
				bundleVersion, className);
