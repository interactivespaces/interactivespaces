...
import interactivespaces.liveactivity.runtime.activity.wrapper.internal.interactivespaces.NativeInteractiveSpacesLiveActivityOsgiBundle;
...
public class LiveActivityBundleTest {
  ...
  public void testFileTwiceDifferent() throws Exception {
    ...
    when(bundleContext.installBundle(newBundleUri)).thenReturn(bundle1).thenReturn(bundle2);
