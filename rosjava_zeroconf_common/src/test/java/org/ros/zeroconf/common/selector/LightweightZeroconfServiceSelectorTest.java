...
public class LightweightZeroconfServiceSelectorTest {
  ...
  public void testGetSingleRegistration() {
    ZeroconfRosMasterInfo masterInfo =
        new ZeroconfRosMasterInfo("scoobydoo", "test", "http", "gloop", 11311, 1, 1);
  ...
  public void testTwoRegistrationOrder1() {
    ZeroconfRosMasterInfo masterInfo1 =
        new ZeroconfRosMasterInfo("scoobydoo1", "test1", "http", "gloop1", 11311, 1, 1);
    ZeroconfRosMasterInfo masterInfo2 =
        new ZeroconfRosMasterInfo("scoobydoo2", "test2", "http", "gloop2", 11311, 2, 1);
  ...
  public void testWeighting() {
    ...
    int weight3 = 10;
    ZeroconfRosMasterInfo masterInfo1 =
        new ZeroconfRosMasterInfo("scoobydoo1", "test1", "http", "gloop1", 11311, 1, weight1);
    ZeroconfRosMasterInfo masterInfo2 =
        new ZeroconfRosMasterInfo("scoobydoo2", "test2", "http", "gloop2", 11311, 1, weight2);
    ZeroconfRosMasterInfo masterInfo3 =
        new ZeroconfRosMasterInfo("scoobydoo3", "test2", "http", "gloop2", 11311, 1, weight3);
