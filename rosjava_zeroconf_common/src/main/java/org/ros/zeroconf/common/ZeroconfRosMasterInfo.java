...
public class ZeroconfRosMasterInfo implements ZeroconfServiceInfo {
  ...
  public ZeroconfRosMasterInfo(String name, String type, String protocols, String hostName,
      int port, int priority, int weight) {
    this.name = name;
    this.type = type;
  ...
  public String toString() {
    return "ZeroconfRosMasterInfo [name=" + name + ", type=" + type + ", protocols=" + protocols
