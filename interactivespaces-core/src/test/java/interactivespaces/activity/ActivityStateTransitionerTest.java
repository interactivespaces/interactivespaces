...
public class ActivityStateTransitionerTest {
	...
	public void testSingleTransitionSuccess() {
		transitioner = new ActivityStateTransitioner(activity,
				ActivityStateTransitioner
						.transitions(ActivityStateTransition.STARTUP), log);
	...
	public void testMultipleTransitionSuccess() {
		...
		transitioner = new ActivityStateTransitioner(activity,
				ActivityStateTransitioner.transitions(
						...
						ActivityStateTransition.ACTIVATE), log);
