...
public class JsonBuilderTest {
	...
	/**
	 * Test putting in various types into an array. This will include a
	 * primitive, an array, and an object.
	 */
	@Test
	public void testArrayAddVariousTypes() {
		...
		List<Object> expectedArray = Lists
				.newArrayList((Object) 17, (Object) 7);
		...
		List<Object> actualArray = (List<Object>) ((List<Object>) root.get(key))
				.get(0);
		assertEquals(expectedArray, actualArray);

		Object actualPrimitiveValue = ((List<Object>) root.get(key))
				.get(1);
		...
		Map<String, Object> actualObjectValue = (Map<String, Object>) ((List<Object>) root.get(key))
				.get(2);
