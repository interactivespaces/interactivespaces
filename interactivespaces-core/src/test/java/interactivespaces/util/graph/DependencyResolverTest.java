...
public class DependencyResolverTest {
	...
	public void testComplicated() {
		...
		List<String> ordering = resolver.getOrdering();
		assertComesAfter(ordering, "a-data", "b-data", "c-data", "d-data",
				"e-data", "f-data");
	 ...
	 * 
	 */
	private void assertComesAfter(List<String> ordering, String after,
			String... befores) {
		...
		for (String before : befores) {
			...
			assertTrue(String.format("%s(%d) should be after %s(%d)", after,
					posAfter, before, posBefore), posBefore < posAfter);
		}
	}
}
