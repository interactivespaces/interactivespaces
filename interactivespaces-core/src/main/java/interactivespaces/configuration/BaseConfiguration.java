...
public abstract class BaseConfiguration
	implements Configuration, EvaluationEnvironment {
    ...
    @Override
    public List<String> getPropertyStringList(
	    String property, String delineator) {
	String value = getValue(property);
	if (value != null) {
    ...
    @Override
    public Set<String> getPropertyStringSet(
	    String property, String delineator) {
	String value = getValue(property);
	if (value != null) {
