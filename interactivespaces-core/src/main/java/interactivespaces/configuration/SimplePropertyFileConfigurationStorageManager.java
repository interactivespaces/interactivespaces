 ...
 */
public class SimplePropertyFileConfigurationStorageManager implements ConfigurationStorageManager {
   ...
   *          the file containing the configuration
   */
  public SimplePropertyFileConfigurationStorageManager(boolean required, File configurationFile,
  ...
  public void save() {
    ...
    try {
      ...
      throw new InteractiveSpacesException(
          "Could not save configuration file " + configurationFile, e);
    } finally {
      if (out != null) {
        try {
          out.close();
