 ...
 */
public abstract class RosMessageBridgeSpecification<SourceMessage, DestinationMessage> extends BaseMessageBridgeSpecification<SourceMessage, DestinationMessage> {
	...
	public RosMessageBridgeSpecification(String sourceTopicName,
			String sourceTopicMessageType, String destinationTopicName,
			String destinationTopicMessageType) {
