...
/**
 * An execution context for activity.
 * 
...
public interface ActivityExecutionContext {
	...
	/**
	 * Get a runnable which will handle method invocation properly.
	 * 
	 * @param runnable
	 * @return
	 */
	...
	/**
	 * Get a callable which will handle method invocation properly.
	 * 
	 * @param callable
	 * @return
	 */
