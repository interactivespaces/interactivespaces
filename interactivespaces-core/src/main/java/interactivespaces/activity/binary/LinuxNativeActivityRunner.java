 ...
 */
public class LinuxNativeActivityRunner extends BaseNativeActivityRunner {
	...
	public LinuxNativeActivityRunner(
	...
	public String[] getCommand() {
		...
		if (appName != null) {
			...
			throw new InteractiveSpacesException("No property called "
					+ ACTIVITYNAME);
		}
	}
