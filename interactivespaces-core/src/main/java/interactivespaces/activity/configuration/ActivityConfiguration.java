...
public class ActivityConfiguration {
	...
	/**
	 * Configuration property giving the location of the activity executable relative
	 * to the activity installation directory.
	 */
	 ...
	 */
	public static final String CONFIGURATION_ACTIVITY_EXECUTABLE_FLAGS = "space.activity.executable.flags";
