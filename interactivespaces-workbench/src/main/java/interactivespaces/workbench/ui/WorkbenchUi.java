...
public class WorkbenchUi extends JFrame implements ActionListener {
  ...
  public JMenuBar getJMenuBar() {
    ...
    saveAllMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, Event.CTRL_MASK | Event.SHIFT_MASK, false));
    ...
    activityStartupAction = new WorkbenchAction("Startup", null, "Startup the activity", new Integer(KeyEvent.VK_L)) {
      @Override
    ...
    activityDeactivateAction =
        new WorkbenchAction("Deactivate", null, "Deactivate the activity", new Integer(KeyEvent.VK_L)) {
          @Override
          public void actionPerformed(ActionEvent e) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (source.equals(openMenuItem)) {
      ...
      JWizardDialog wizard = new JWizardDialog("New Project", this, new NewProjectWizard(this, workbench));
  ...
  private void openActivityProject(File baseProjectDir) {
    ...
    if (workbench.getProjectManager().isProjectFolder(baseProjectDir)) {
      setCurrentProject(workbench.getProjectManager().readProject(baseProjectDir, workbench.getLog()));
    } else {
