...
package interactivespaces.controller.runtime.ros;
...
import interactivespaces.container.controller.common.ros.RosSpaceControllerConstants;
...
public class RosSpaceControllerCommunicator implements SpaceControllerCommunicator {
   ...
   *          space environment
   */
  public RosSpaceControllerCommunicator(RosEnvironment rosEnvironment, InteractiveSpacesEnvironment spaceEnvironment) {
  ...
  public void onStartup() {
    ...
    configurationRequestDeserializer = messageSerializationFactory.newMessageDeserializer(ConfigurationRequest._TYPE);
  ...
  void handleControllerRequest(interactivespaces_msgs.ControllerRequest request) {
    switch (request.getOperation()) {
      ...
      case ControllerRequest.OPERATION_CONTROLLER_CONFIGURE:
        handleControllerConfigurationRequest(configurationRequestDeserializer.deserialize(request.getPayload()));
  ...
  /**
   * Translate an Interactive Spaces activity status to its ROS message equivalent.
   *
   * @param state
   *          object
   * @return status code
