...
public class DatabaseBundleActivator implements BundleActivator {
  ...
  public void start(BundleContext context) throws Exception {
    try {
      ...
      Connection conn =
          DriverManager.getConnection("jdbc:derby:database/interactivespaces;create=true");
      conn.close();
    } catch (Exception e) {
  ...
  public void stop(BundleContext context) throws Exception {
    try {
      Connection conn =
          DriverManager.getConnection("jdbc:derby:database/interactivespaces;shutdown=true");
      conn.close();
    } catch (Exception e) {
