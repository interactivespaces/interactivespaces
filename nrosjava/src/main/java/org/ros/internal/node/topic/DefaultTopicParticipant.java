...
public abstract class DefaultTopicParticipant implements TopicParticipant {
  ...
  /**
   * Signal that the {@link TopicSystemState} successfully registered with the
   * master.
   */
  public abstract void signalOnMasterRegistrationSuccess();

  /**
   * Signal that the {@link TopicSystemState} failed to register with the
   * master.
   */
  public abstract void signalOnMasterRegistrationFailure();

  /**
   * Signal that the {@link TopicSystemState} successfully unregistered with the
   * master.
   */
  public abstract void signalOnMasterUnregistrationSuccess();

  /**
   * Signal that the {@link TopicSystemState} failed to unregister with the
   * master.
   */
