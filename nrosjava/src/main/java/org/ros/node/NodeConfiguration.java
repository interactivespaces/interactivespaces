...
public class NodeConfiguration {
	 ...
	 * @param masterUri
	 *            the {@link URI} for the master that the {@link Node} will
	 *            register with
	...
	public static NodeConfiguration newPublic(String host, URI masterUri) {
		...
		configuration
				.setXmlRpcAdvertiseAddressFactory(new PublicAdvertiseAddressFactory(
						host));
		configuration.setTcpRosBindAddress(BindAddress.newPublic());
		configuration
				.setTcpRosAdvertiseAddressFactory(new PublicAdvertiseAddressFactory(
						host));
	...
	public static NodeConfiguration newPrivate(URI masterUri) {
		...
		configuration
				.setXmlRpcAdvertiseAddressFactory(new PrivateAdvertiseAddressFactory());
		configuration.setTcpRosBindAddress(BindAddress.newPrivate());
		configuration
				.setTcpRosAdvertiseAddressFactory(new PrivateAdvertiseAddressFactory());
		configuration.setMasterUri(masterUri);
		return configuration;
	}
	...
	private NodeConfiguration() {
		...
		setTopicDescriptionFactory(new TopicDescriptionFactory(
				messageDefinitionProvider));
		setTopicMessageFactory(new DefaultMessageFactory(
				messageDefinitionProvider));
		setServiceDescriptionFactory(new ServiceDescriptionFactory(
				messageDefinitionProvider));
		setServiceRequestMessageFactory(new ServiceRequestMessageFactory(
				messageDefinitionProvider));
		setServiceResponseMessageFactory(new ServiceResponseMessageFactory(
				messageDefinitionProvider));
		setMessageSerializationFactory(new DefaultMessageSerializationFactory(
				messageDefinitionProvider));
	...
	/**
	 * @param resolver
	 *            the {@link NameResolver} for the {@link Node}'s parent
	 *            namespace
	 ...
	 *      documentation</a>
	 * @param masterUri
	 *            the {@link URI} of the master that the {@link Node} will
	 *            register with
	 * @return this {@link NodeConfiguration}
	 */
	 ...
	 * packages. If there are multiple packages of the same name, ROS will
	 * choose the one that appears in the {@link List} first.
	 * 
	 * @see <a
	 ...
	 * @return this {@link NodeConfiguration}
	 */
	public NodeConfiguration setTopicMessageFactory(
	...
	/**
	 * @see <a href="http://www.ros.org/wiki/ROS/TCPROS">TCPROS
	 *      documentation</a>
	 * 
	 ...
	 *            the {@link AdvertiseAddressFactory} for the {@link Node}'s
	 *            TCPROS server
	 * @return this {@link NodeConfiguration}
	 */
	 ...
	 *      documentation</a>
	 * 
	 * @return the {@link AdvertiseAddress} for the {@link Node}'s XML-RPC
	 *         server
	 */
	 ...
	 *      documentation</a>
	 * 
	 * @return the {@link AdvertiseAddressFactory} for the {@link Node}'s
	 *         XML-RPC server
	 */
	...
	/**
	 * Sets the {@link TimeProvider} that {@link Node}s will use. By default,
	 * the {@link WallTimeProvider} is used.
	 * 
	 * @param timeProvider
