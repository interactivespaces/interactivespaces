...
public class AndroidLoggingProvider implements LoggingProvider {
  ...
  static {
    ...
    levelPriorities.put(LoggingProvider.LOG_LEVEL_FATAL, LOG_PRIORITY_FATAL);
  ...
  public Log getLog(String name, String level) {
    ...
    if (priority != null) {
      ...
      String message = String.format("Illegal log priority level %s", level);
      log.error(message);
  ...
  private static class AndroidLog implements Log {
    ...
    public void fatal(Object arg0, Throwable arg1) {
      if (isFatalEnabled()) {
        android.util.Log.wtf(name, arg0.toString(), arg1);
      }
    }
    ...
    public boolean isDebugEnabled() {
      return levelPriority <= LOG_PRIORITY_DEBUG && LOG_PRIORITY_OFF != levelPriority;
    }

    @Override
    public boolean isErrorEnabled() {
      return levelPriority <= LOG_PRIORITY_ERROR && LOG_PRIORITY_OFF != levelPriority;
    }

    @Override
    public boolean isFatalEnabled() {
      return levelPriority <= LOG_PRIORITY_FATAL && LOG_PRIORITY_OFF != levelPriority;
    }

    @Override
    public boolean isInfoEnabled() {
      return levelPriority <= LOG_PRIORITY_INFO && LOG_PRIORITY_OFF != levelPriority;
    }

    @Override
    public boolean isTraceEnabled() {
      return levelPriority <= LOG_PRIORITY_TRACE && LOG_PRIORITY_OFF != levelPriority;
    }

    @Override
    public boolean isWarnEnabled() {
      return levelPriority <= LOG_PRIORITY_WARN && LOG_PRIORITY_OFF != levelPriority;
    }
