...
public class EscapedXBeeResponseFrameParser implements XBeeResponseFrameParser {
	...
	@Override
	public AtRemoteResponseXBeeFrame parseAtRemoteResponse(
			EscapedXBeeFrameReader reader, int bytesLeft, Log log) {
	...
	@Override
	public TxStatusXBeeFrame parseTxStatus(EscapedXBeeFrameReader reader,
	...
	@Override
	public RxResponseXBeeFrame parseReceiveResponse(
			EscapedXBeeFrameReader reader, int bytesLeft, Log log) {
		log.info("RX Receive");
