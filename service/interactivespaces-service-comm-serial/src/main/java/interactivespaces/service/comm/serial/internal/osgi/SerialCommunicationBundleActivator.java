 ...
 */
public class SerialCommunicationBundleActivator extends InteractiveSpacesServiceOsgiBundleActivator {

  @Override
  protected void allRequiredServicesAvailable() {
    RxtxSerialCommunicationEndpointService serialCommService =
        new RxtxSerialCommunicationEndpointService();
    registerNewInteractiveSpacesService(serialCommService);
  }
}
