 ...
 */
public class OsgiScriptServiceActivator implements BundleActivator {
	 ...
	 */
	private JavaxScriptScriptService scriptService;

	/**
	 * OSGi service registration for the script service.
	 */
	private ServiceRegistration scriptServiceRegistration;
	...
	public void stop(BundleContext context) throws Exception {
		scriptServiceRegistration.unregister();
	...
	private void gotAnotherReference() {
		synchronized (serviceLock) {
			...
			scriptServiceRegistration = bundleContext.registerService(
					ScriptService.class.getName(), scriptService, null);
		}
	}
