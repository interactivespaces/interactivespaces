...
public class EscapedXBeeFrameReader {
	...
	/**
	 * Scan until either the start frame is found, or the end of stream is
	 * found.
	 * 
	...
	public boolean waitForStartFrame() {
		...
		// is reached.
		int b;
		while ((b = endpoint.read()) != XBeeApiConstants.FRAME_START_BYTE
				&& b != -1)
			;
	...
	public int readByte() {
		...
		if (b == -1) {
			throw new InteractiveSpacesException(
					"End of stream reached while reading XBee frame");
		}
