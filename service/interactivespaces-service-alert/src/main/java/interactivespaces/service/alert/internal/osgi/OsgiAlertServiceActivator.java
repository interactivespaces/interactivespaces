...
package interactivespaces.service.alert.internal.osgi;
 ...
 */
public class OsgiAlertServiceActivator extends InteractiveSpacesServiceOsgiBundleActivator {

  @Override
  protected void allRequiredServicesAvailable() {
    BasicAlertService alertService = new BasicAlertService();

    registerNewInteractiveSpacesService(alertService);
