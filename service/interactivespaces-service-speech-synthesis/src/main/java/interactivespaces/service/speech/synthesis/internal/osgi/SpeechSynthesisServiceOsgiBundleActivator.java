 ...
 */
public class SpeechSynthesisServiceOsgiBundleActivator implements BundleActivator {
	...
	public void stop(BundleContext context) throws Exception {
		...
		interactiveSpacesEnvironmentTracker.getMyService().getServiceRegistry()
				.unregisterService(SpeechSynthesisService.SERVICE_NAME, speechSynthesisService);
	...
	private void gotAnotherReference() {
		synchronized (serviceLock) {
			...
			interactiveSpacesEnvironmentTracker.getMyService()
					.getServiceRegistry()
					.registerService(SpeechSynthesisService.SERVICE_NAME, speechSynthesisService);
