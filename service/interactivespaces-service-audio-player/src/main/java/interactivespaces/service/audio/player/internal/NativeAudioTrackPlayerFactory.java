...
/**
 * A {@link AudioTrackPlayerFactory} which gives track players which are
 * natively run.
 *
...
public class NativeAudioTrackPlayerFactory implements AudioTrackPlayerFactory {
  ...
  public NativeAudioTrackPlayerFactory(NativeActivityRunnerFactory runnerFactory, Log log) {
    this.runnerFactory = runnerFactory;
    this.log = log;
  }

  @Override
  public AudioTrackPlayer newTrackPlayer(PlayableAudioTrack ptrack, Configuration configuration,
      Log log) {
