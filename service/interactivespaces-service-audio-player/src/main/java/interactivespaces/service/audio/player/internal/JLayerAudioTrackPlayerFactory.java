...
public class JLayerAudioTrackPlayerFactory implements AudioTrackPlayerFactory {
  ...
  @Override
  public AudioTrackPlayer newTrackPlayer(PlayableAudioTrack track, Configuration configuration,
      Log log) {
    return new JLayerAudioTrackPlayer(configuration, track, spaceEnvironment.getExecutorService(),
        log);
  }
