...
public class QuartzSchedulerService implements SchedulerService {
  ...
  public void startup() {
    try {
      ...
      throw new InteractiveSpacesException("Could not start Interactive Spaces scheduler", e);
    }
  }
  ...
  public void shutdown() {
    try {
      ...
      throw new InteractiveSpacesException("Could not shutdown Interactive Spaces scheduler", e);
    }
  }
  ...
  public void addSchedulingEntities(Map<String, Object> entities) {
    try {
      ...
      throw new InteractiveSpacesException("Unable to add map of entities to the scheduler", e);
    }
  }
