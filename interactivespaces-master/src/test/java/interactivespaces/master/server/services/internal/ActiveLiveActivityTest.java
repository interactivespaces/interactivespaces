...
public class ActiveLiveActivityTest extends BaseSpaceTest {
	...
	public void setup() {
		...
		activeLiveActivityGroup1 = new ActiveLiveActivityGroup(
				liveActivityGroup1);
		liveActivityGroup2 = liveActivityGroup(12);
		activeLiveActivityGroup2 = new ActiveLiveActivityGroup(
				liveActivityGroup2);

		activeLiveActivity = new ActiveLiveActivity(activeSpaceController,
				liveActivity, remoteControllerClient, timeProvider);
	}
	...
	public void groupActivityStartup() {
		activeLiveActivity
				.startupFromLiveActivityGroup(activeLiveActivityGroup1);
	...
	public void groupTwoActivityStartup() {
		activeLiveActivity
				.startupFromLiveActivityGroup(activeLiveActivityGroup1);
		activeLiveActivity
				.startupFromLiveActivityGroup(activeLiveActivityGroup2);
	...
	public void groupTwoActivityStartupAndOneShutdown() {
		...
		activeLiveActivity
				.startupFromLiveActivityGroup(activeLiveActivityGroup2);
		activeLiveActivity
				.shutdownFromLiveActivityGroup(activeLiveActivityGroup1);
	...
	public void groupTwoActivityStartupAndTwoShutdown() {
		...
		activeLiveActivity
				.shutdownFromLiveActivityGroup(activeLiveActivityGroup1);
		activeLiveActivity
				.shutdownFromLiveActivityGroup(activeLiveActivityGroup2);
	...
	public void groupActivityActivate() {
		activeLiveActivity
				.activateFromLiveActivityGroup(activeLiveActivityGroup1);
	...
	public void groupTwoActivityActivateAndOneDeactivate() {
		activeLiveActivity
				.activateFromLiveActivityGroup(activeLiveActivityGroup1);
		activeLiveActivity
				.activateFromLiveActivityGroup(activeLiveActivityGroup2);
		activeLiveActivity
				.deactivateFromLiveActivityGroup(activeLiveActivityGroup1);
	...
	public void groupTwoActivityActivateAndTwoDeactivate() {
		...
		activeLiveActivity
				.deactivateFromLiveActivityGroup(activeLiveActivityGroup1);
		activeLiveActivity
				.deactivateFromLiveActivityGroup(activeLiveActivityGroup2);
