...
public class BasicActiveControllerManagerTest {
	...
	public void testActivityInstallSuccess() {
		...
		ActiveLiveActivity active = controllerManager
		...
		Mockito.verify(listener).onLiveActivityInstall(activityUuid, result,
				timestamp);
	...
	public void testActivityDeleteSucccess() {
		...
		Mockito.verify(listener).onLiveActivityDelete(activityUuid, result,
				timestamp);
