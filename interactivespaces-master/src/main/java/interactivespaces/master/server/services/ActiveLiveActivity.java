...
public class ActiveLiveActivity {
	...
	public ActiveLiveActivity(ActiveSpaceController activeController,
	...
	/**
	 * Is the live activity activated from a direct call (not just from a
	 * group)?
	 * 
	...
	/**
	 * Get the number of groups which currently think they activated the
	 * activity.
	 * 
	 * @return the number of groups
	 */
	 ...
	 */
	public synchronized void startupFromLiveActivityGroup(
			ActiveLiveActivityGroup group) {
		if (!isRunning()) {
			attemptRemoteStartup();
		}
	 ...
	 *            the live activity group
	 */
	public synchronized void shutdownFromLiveActivityGroup(
			ActiveLiveActivityGroup group) {
	 ...
	 *            the live activity group
	 */
	public synchronized void activateFromLiveActivityGroup(
			ActiveLiveActivityGroup group) {
		if (!isActivated()) {
			attemptRemoteActivation();
		}
	 ...
	 *            the live activity group
	 */
	public synchronized void deactivateFromLiveActivityGroup(
			ActiveLiveActivityGroup group) {
	 ...
	 * 
	 * @return The time in milliseconds from the epoch of the last status
	 *         update. {@code null} means there hasn't been one yet.
	 */
