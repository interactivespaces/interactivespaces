...
public class SpaceControllerListenerHelper {
   ...
   */
  public void signalActivityDelete(String uuid, LiveActivityDeleteResult result, long timestamp) {
    for (SpaceControllerListener listener : listeners) {
   ...
   */
  public void signalLiveActivityStateChange(String uuid, ActivityState oldState,
