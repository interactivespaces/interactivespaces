...
public interface MasterDomainDescription {
   ...
   */
  public static final String ELEMENT_NAME_DESCRIPTION_ROOT_ELEMENT =
   ...
   * version.
   */
  public static final String ELEMENT_NAME_ACTIVITY_DEPENDENCY_VERSION_MINIMUM =
   ...
   * version.
   */
  public static final String ELEMENT_NAME_ACTIVITY_DEPENDENCY_VERSION_MAXIMUM =
   ...
   * property.
   */
  public static final String ELEMENT_NAME_ACTIVITY_DEPENDENCY_REQUIRED =
   ...
   */
  public static final String ELEMENT_NAME_LIVE_ACTIVITY_GROUP_ROOT_GROUP_LIVE_ACTIVITIES =
   ...
   */
  public static final String ELEMENT_NAME_LIVE_ACTIVITY_GROUP_INDIVIDUAL_GROUP_LIVE_ACTIVITY =
      "group-live-activity";
   ...
   * parameters.
   */
  public static final String ELEMENT_NAME_ACTIVITY_CONFIGURATION_ROOT_PARAMETERS =
   ...
   */
  public static final String ELEMENT_NAME_SPACE_INDIVIDUAL_LIVE_ACTIVITY_GROUP =
      "live-activity-group";
