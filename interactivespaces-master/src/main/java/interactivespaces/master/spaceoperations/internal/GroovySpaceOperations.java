...
public class GroovySpaceOperations implements SpaceOperations {
	...
	public void run() {
		try {
			String[] roots = new String[] { "/home/khughes/robots/ros/interactive-spaces/interactivespaces_scripts" };
			GroovyScriptEngine gse = new GroovyScriptEngine(roots);
			Binding binding = new Binding();
			binding.setVariable("args", new String[] { "-s=/home/khughes/robots/ros/interactive-spaces/interactivespaces_scripts", "sample.description", "deploy"});
