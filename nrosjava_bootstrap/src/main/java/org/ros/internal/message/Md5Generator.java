...
public class Md5Generator {
	...
	public String generate(String messageType) {
		...
		Preconditions.checkNotNull(messageDefinition,
				"No definition for message type: " + messageType);
		List<String> parts = MessageDefinitionTupleParser.parse(
				messageDefinition, -1);
	...
	private String generateText(String messageType, String messageDefinition) {
		...
		MessageDefinitionParser messageDefinitionParser = new MessageDefinitionParser(
				visitor);
